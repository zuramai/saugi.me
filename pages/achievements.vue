<template>
    <div id="page-content" class='container'>
        <div class="flex w-full">
            <h1 class='page-heading text-6xl text-center mx-auto mt-32 font-light text-gray-800 mb-8'>Achievements</h1>
        </div>
                ...
                <div class="achievements">
                    <ul class="achievements">
                        <li class='achievement flex flex-col md:flex-row text-left justify-start   items-center mb-5'>
                            <img src="/images/icon/trophy.svg" alt="Trophy" class='w-8'/>
