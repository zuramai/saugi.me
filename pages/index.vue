<template>
  <div class="container">
    <div class='flex flex-col mx-auto mt-64 text-center'>
      <div class="image">
      <img src="@/assets/images/ogi.png" alt="My Picture" class="mx-auto w-64">
      </div>
      ...
      <div class="links d-flex flex-row mt-5">
        <a class='socmed inline-block mr-4 duration-200 ease-in-out' href="https://www.facebook.com/ahmadsaugi.gis">
